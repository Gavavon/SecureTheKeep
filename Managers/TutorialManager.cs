...
public class TutorialManager : MonoBehaviour
{
	...
	{
		"Welcome back Wizard! Our fort is under siege but you're here so we should be good.",
		...
		"You can attack them with your magic, but be careful our magic source you pull from is a bit drained.",
		"For now some of your more powerful spells have a cool down.",
		"Additionally, we have our construction workers making repairs to the gate after every wave of enemies.",
